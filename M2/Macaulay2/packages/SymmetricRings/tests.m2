...
TEST ///
    ...
    assert(multiplyToBasis(hTest_2, eTest_1, hTest) == hTest_2*toBasis(eTest_1, hTest))
    assert(multiplyToBasis(eTest_2, hTest_1, eTest) == eTest_2*toBasis(hTest_1, eTest))
...
TEST ///
    ...
    assert(multiplyToBasis(q_2, p_1, q) == q_2*toBasis(p_1, q))
    assert(multiplyToBasis(p_1, b_2, b) == toBasis(p_1, b)*b_2)
...
TEST ///
    ...
    assert(toS(S_{5,3,2}*S_{4,3,1}) == toSLegacy(S_{5,3,2}*S_{4,3,1}))
    assert(toS(S_{3,2}*h_{3,2}) == toSLegacy(S_{3,2}*h_{3,2}))
    assert(toS(S_{3,2}*e_{2,1}) == toSLegacy(S_{3,2}*e_{2,1}))
    assert(toS(S_{3,2}*S_{2,1} + e_4 + p_{3,1}) == toSLegacy(S_{3,2}*S_{2,1} + e_4 + p_{3,1}))
    assert(toS(S_{2,1}*S_{1,3}) == toS(S_{2,1}*straighten S_{1,3}))
    assert(toS(S_{2,1}*S_{1,2}) == 0_R0)
    assert(toS(S_{3,1}*p_2) == toSLegacy(S_{3,1}*p_2))
    assert(toS(S_{3,1}*p_{3,2}) == toSLegacy(S_{3,1}*p_{3,2}))
    assert(toS(p_{3,2}) == toSLegacy(p_{3,2}))
    assert(toS(S_{3,2}*h_2*e_1*p_3) == toSLegacy(S_{3,2}*h_2*e_1*p_3))
    assert(toS(S_{{4,2}, {1}}) == toSLegacy(S_{{4,2}, {1}}))
    assert(toS(S_{3,1}*S_{{4,2}, {1}}) == toSLegacy(S_{3,1}*S_{{4,2}, {1}}))
    assert(toS(S_{{4,2}, {1}}*S_{{3,1}, {1}}) == toSLegacy(S_{{4,2}, {1}}*S_{{3,1}, {1}}))
    assert(multiplyToS(S_{5,3,2}, S_{4,3,1}) == toS(S_{5,3,2}*S_{4,3,1}))
    assert(multiplyToS(S_{3,2}, h_{3,2}*e_1) == toS(S_{3,2}*h_{3,2}*e_1))
    assert(multiplyToS(S_{3,1}, p_2) == toS(S_{3,1}*p_2))
    assert(multiplyToS(S_{3,2}*h_2, e_1*p_3) == toS(S_{3,2}*h_2*e_1*p_3))
    assert(multiplyToS(S_{3,1}, S_{{4,2}, {1}}) == toS(S_{3,1}*S_{{4,2}, {1}}))
    assert(multiplyToS(S_{{4,2}, {1}}, S_{{3,1}, {1}}) == toS(S_{{4,2}, {1}}*S_{{3,1}, {1}}))
    assert(multiplyToBasis(S_{5,3,2}, S_{4,3,1}, S) == multiplyToS(S_{5,3,2}, S_{4,3,1}))
    assert(multiplyToBasis(h_{3,2}, h_{4,1}, h) == h_{4,3,2,1})
    assert(multiplyToBasis(p_{3,2}, p_{4,1}, p) == p_{4,3,2,1})
    assert(multiplyToBasis(S_2, h_1, h) == toBasis(S_2*h_1, h))
    assert(multiplyToBasis(h_2, S_{2,1}, h) == h_2*toBasis(S_{2,1}, h))
    assert(multiplyToBasis(S_{2,1}, e_2, e) == toBasis(S_{2,1}, e)*e_2)
    assert(multiplyToBasis(p_2, S_{2,1}, p) == p_2*toBasis(S_{2,1}, p))
    assert(multiplyToBasis(m_1, h_1, m) == m_2 + 2*m_{1,1})
    assert(multiplyToBasis(m_2, p_1, m) == m_3 + m_{2,1})
    assert(multiplyToBasis(m_{1,1}, p_1, m) == m_{2,1} + 3*m_{1,1,1})
    assert(multiplyToBasis(m_{2,1}, h_2*e_1*p_2, m) == toBasis(m_{2,1}*h_2*e_1*p_2, m))
    assert(multiplyToBasis(ff_{2,1}, e_2, ff) == toBasis(ff_{2,1}*e_2, ff))
    assert(multiplyToBasis(ff_{2,1}, h_2, ff) == toBasis(ff_{2,1}*h_2, ff))
    assert(multiplyToBasis(ff_{2,1}, p_2, ff) == toBasis(ff_{2,1}*p_2, ff))
    assert(multiplyToBasis(ff_{2,1}, e_2*h_1*p_2, ff) == toBasis(ff_{2,1}*e_2*h_1*p_2, ff))
